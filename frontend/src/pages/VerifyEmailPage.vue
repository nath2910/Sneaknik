<template>
  <div class="relative min-h-screen bg-slate-950 px-4 py-10">
    <div class="mx-auto w-full max-w-2xl">
      <div class="rounded-3xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-slate-900/60 p-8 shadow-2xl">
        ...
        <div class="mt-8 flex flex-wrap gap-3">
          <button
            ...
            class="inline-flex items-center rounded-xl border border-slate-700 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-slate-500 hover:text-white disabled:opacity-60"
            @click="resendEmail"
          >
          ...
          <router-link
            v-if="status === 'success'"
            class="inline-flex items-center rounded-xl bg-emerald-500 px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-emerald-400"
          ...
          <router-link
            v-else
            class="inline-flex items-center rounded-xl border border-slate-700 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:border-slate-500 hover:text-white"
            :to="{ name: 'auth', query: { mode: 'login' } }"
          >
            Retour
          </router-link>
